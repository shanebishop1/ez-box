...
After the [Quick start](../README.md#quick-start), with Node.js 20+, an `E2B_API_KEY` in `.env`, and an `ez-devbox.config.toml` in the current directory:
...
Any public recording should redact sandbox IDs, credentials, and private repository names.
